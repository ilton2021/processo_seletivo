		   ...
		   <div class="page-content">
			 <section  class="sppb-section " style="background-repeat:no-repeat;background-size:cover;background-attachment:fixed;background-position:0 0;">
			  ...
			  <table class="table table-responsive table-border" border="2" bordercolor=DCDCDC>
				...
				<tr id="tr1">
					<td><center><a class="btn btn-success btn-sm" style="margin-top: 10px; color: #FFFFFF; opacity: 30%;" id="btn" name="btn"> Área do Candidato</a></center></td>
				</tr>
				<tr id="tr2" hidden>
					<td><center><a href="{{ url('areaCandidato') }}" class="btn btn-success btn-sm" style="margin-top: 10px; color: #FFFFFF;" id="btn" name="btn"> Área do Candidato</a></center></td>
				</tr>
			</table>
	    </section>
		
	  </div>
	  <link rel='stylesheet' id='cookie-law-info-table-css' href='https://www.hcp.org.br/wp-content/plugins/cookie-law-info/public/css/cookie-law-info-table.css?ver=2.1.2' media='all' />
  </body>
</html>