			  ...
			  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                   <tr>
					 ...
					 <td>Salário Bruto:</td>
					 <td>Vagas:</td>
					 <td><center>Competências</center></td>
				   ...
				   <tr>
					 ...
					 <td><center><a title="Visualizar" class="btn btn-warning btn-sm" style="color: #FFFFFF;" href="{{route('cadastroVagaExperiencias', array($processos[0]->id, $vaga->id))}}" > <i class="fas fa-eye"></i></a></center></td>
