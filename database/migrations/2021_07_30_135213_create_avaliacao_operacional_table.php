...
class CreateAvaliacaoOperacionalTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('avaliacao_operacional', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('avaliacao_operacional');
    }
}
