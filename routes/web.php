...
Route::get('areaCandidato/{id}', 'CandidatoController@areaCandidatoAlterar')->name('areaCandidatoAlterar');
Route::post('areaCandidato/{id}', 'CandidatoController@updateAreaCandidatoAlterar')->name('updateAreaCandidatoAlterar');
...
Route::get('painelCandidato/pcd/{id}/{id_p}/{id_c}', 'CandidatoController@painelCandidatoPCD')->name('painelCandidatoPCD'); 
Route::post('painelCandidato/pcd/{id}/{id_p}/{id_c}', 'CandidatoController@validarCandidatoPCD')->name('validarCandidatoPCD'); 
Route::get('painelCandidato/experiencias/aviso/{id}/{id_p}/{id_c}', 'CandidatoController@painelCandidatoExperienciasAviso')->name('painelCandidatoExperienciasAviso'); 
Route::get('painelCandidato/experiencias/{id}/{id_p}/{id_c}', 'CandidatoController@painelCandidatoExperiencias')->name('painelCandidatoExperiencias'); 
Route::post('painelCandidato/experiencias/{id}/{id_p}/{id_c}', 'CandidatoController@validarCandidatoExperiencias')->name('validarCandidatoExperiencias'); 
Route::get('painelCandidato/questionario/{id}/{id_p}/{id_c}', 'CandidatoController@painelCandidatoQuestionario')->name('painelCandidatoQuestionario'); 
Route::post('painelCandidato/questionario/{id}/{id_p}/{id_c}', 'CandidatoController@validarCandidatoQuestionario')->name('validarCandidatoQuestionario'); 
