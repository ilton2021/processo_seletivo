function validar(valor) {
    ...
    if(valida) {
        ...
        var x1_ = document.getElementById('arquivo_').value;
        var x2  = document.getElementById('foto').value;
        var x2_ = document.getElementById('foto_').value;
...
function valoresCampos() {
    ...
    if(document.getElementById('foto').value == "") {
        document.getElementById('foto_').value = " ";
    }
    if(document.getElementById('arquivo').value == "") {
        document.getElementById('arquivo_').value = " ";
    }
}